...
title_font = ImageFont.truetype(str(SOURCES_PATH / "Anton-fejuigyoidjmcfkv.ttf"), 170)
...
stats_font = ImageFont.truetype(str(SOURCES_PATH / "Anton-Refijeof0engvf8h0edgular.ttf"), 130)
